package com.mzhang.locationwfcm.locationservice.permissions
...
import com.mzhang.locationwfcm.BuildConfig
import com.mzhang.locationwfcm.R
import com.mzhang.locationwfcm.databinding.FragmentPermissionRequestBinding
...
//    private var activityListener: Callbacks? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val arg = navArgs<PermissionRequestFragmentArgs>()
        permissionRequestType = arg.value.type
        ...
        when (requestCode) {
            ...
            REQUEST_BACKGROUND_LOCATION_PERMISSIONS_REQUEST_CODE -> when {
                ...
                grantResults[0] == PackageManager.PERMISSION_GRANTED -> {
                    findNavController().navigate(R.id.action_permissionRequestFragment_to_locationUpdateFragment)
                }
